 ...
 */
#define USE_CONTROLLER_FAN                    // 3DWORK FAN1 assigned Mainboard Fan
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN1_PIN         // 3DWORK FAN1  // Set a custom pin for the controller fan
  ...
  #define CONTROLLER_FAN_EDITABLE             // 3DWORK FAN1       // Enable M710 configurable settings
 ...
 */
#define E0_AUTO_FAN_PIN FAN2_PIN          // 3DWORK FAN2 assigned hotend Fan alter Wert -1
...
#define COOLER_AUTO_FAN_PIN FAN_PIN       // 3DWORK FAN0 assigned Partcooling Fan alter Wert -1
...
// @section bltouch
  ...
  #define BLTOUCH_FORCE_SW_MODE     // 3DWORK E3MV30
 ...
 */
//#define Z_STEPPER_AUTO_ALIGN        // TFT35 IMPROVEMENTS
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD                                   // 3DWORK Probe  // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0                    // 3DWORK PROBE

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER }   // 3DWORK PROBE
  #endif
#endif
  ...
  #define LCD_INFO_MENU                       // 3DWORK E3MV30
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 9000       // (ms) Total Duration to display the boot screen(s)
  ...
  #define STATUS_MESSAGE_SCROLLING     // 3DWORK E3MV30
...
#define SET_PROGRESS_MANUALLY                 // 3DWORK E3MV30
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY               // 3DWORK POWER
   ...
   */
  #define SDCARD_SORT_ALPHA  // 3DWORK TFT
  ...
  #define UTF_FILENAME_SUPPORT            // 3DWORK E3MV30

  #define LONG_FILENAME_HOST_SUPPORT      // 3DWORK IMPROVEMENTS  // TFT35 IMROVEMENTS  // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  ...
  #define AUTO_REPORT_SD_STATUS           // TFT35 IMROVEMENTS  // Auto-report media status with 'M27 S<seconds>'
   ...
   */
  #define SDCARD_CONNECTION ONBOARD     // 3DWORK SD  // TFT35 SD

  // Enable if SD detect is rendered useless (e.g., by using an SD extender)
  #define NO_SD_DETECT                  // CJMWORK SD-Karten extender verbaut.
 ...
 */
#define BABYSTEPPING                        // 3DWORK IMPROVEMENTS  // TFT35 IMROVEMENTS
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING           // 3DWORK E3MV30
  #define BABYSTEP_ALWAYS_AVAILABLE         // 3DWORK E3MV30    // Allow babystepping at all times (not just during movement).
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  //#define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  1       // 3DWORK E3MV30 // (steps or mm) Steps or millimeter distance for each Z babystep
  ...
  #define BABYSTEP_DISPLAY_TOTAL            // 3DWORK E3MV30 // Display total babysteps since last G28
 ...
 */
#define LIN_ADVANCE                 // 3DWORK E3MV30
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.0 }       // 3DWORK E3MV30 Alter Wert 0.22 // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.0           // 3DWORK E3MV30 Alter Wert 0.22 // (mm) Compression length applying to all extruders
  #endif
  //#define ADVANCE_K_EXTRA         // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG                // Print debug information to serial during operation. Disable for production use.
  #define EXPERIMENTAL_SCURVE       // 3DWORK E3MV30 // Allow S-Curve Acceleration to be used with LA.
...
#define G29_RETRY_AND_RECOVER       // 3DWORK IMPROVEMENTS
  ...
  #define G29_MAX_RETRIES 4         // 3DWORK IMPROVEMENTS alter Wert 3
 ...
 */
#define EMERGENCY_PARSER      // TFT35 IMROVEMENTS
...
#define SERIAL_FLOAT_PRECISION 4      // TFT35 IMROVEMENTS
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // 3DWORK FILAMENT SENSOR  // TFT35 FILAMENT SENSOR
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // 3DWORK E3MV30 Alter Wert 45  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // 3DWORK E3MV30 Alter Wert 10 // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     10  // 3DWORK E3MV30 Alter Wert 20 // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      400  // 3DWORK E3MV30 Alter Wert 830 // (mm) The length of filament for a complete unload.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     0  // 3DWORK E3MV30 Alter Wert 20 // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // 3DWORK E3MV30 Aleter Wert 15 // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // 3DWORK E3MV30 Alter Wert 830 // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define HOME_BEFORE_FILAMENT_CHANGE             // 3DWORK E3MV30 // If needed, home before parking for filament change
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  X_CURRENT / 2  // 3DWORK E3MV30 // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  Y_CURRENT  / 2   // 3DWORK E3MV30
    ...
    #define Z_CURRENT_HOME  Z_CURRENT  / 2    // 3DWORK E3MV30
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // 3DWORK DRIVERS alter Wert 12V  // All axes (override below)
 ...
 #define HYBRID_THRESHOLD                           // 3DWORK DRIVERS
  ...
  #define Z_HYBRID_THRESHOLD      15                // // 3DWORK Alter Wer 3
  ...
  #define DIAG_JUMPERS_REMOVED
    ...
    #define IMPROVE_HOMING_RELIABILITY     // 3DWORK E3MV30
  #endif
 ...
 */
#define AUTO_REPORT_TEMPERATURES      // TFT35 IMROVEMENTS
 ...
 */
#define AUTO_REPORT_POSITION          // TFT35 IMROVEMENTS
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT        // TFT35 IMROVEMENTS
#endif
...
#define M114_DETAIL           // TFT35 IMROVEMENTS  // Use 'M114` for details to check planner calculations
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE     // TFT35 IMROVEMENTS  // Report the new fan speed when changed by M106 (and others)
...
#if ENABLED(HOST_ACTION_COMMANDS)         // TFT35 IMROVEMENTS
  #define HOST_PAUSE_M76                  // 3DWORK E3MV30      // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT             // TFT35 IMROVEMENTS  // Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS     // TFT35 IMROVEMENTS  // Send some status messages to the host as notifications
  #endif
